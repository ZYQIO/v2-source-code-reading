...
const builds = {
  ...
  'full-dev': {
    ...
    // 打包格式
    // 1. umd: 通用模块加载规范, 同时兼容 Commonjs 与 AMD/CMD
    // 2. Commonjs: 常用语 node 服务端, ssr
    // 3. esm: ES6 Module, import, export default
    // 4. AMD: 用于浏览器端, AMD规范采用异步方式加载模块
    // 5. CMD: 用于浏览器端, 同AMD一样, 按需加载
    format: 'umd',
    env: 'development',
    alias: { he: './entity-decoder' },
    banner
